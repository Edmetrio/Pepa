        ...
        <div class="row">
                ...
                <div class="row" style="margin: 2%">
                    <div class="col-lg-12">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-success" href="{{ route('categorias.create')}}"> Adicionar </a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered" >
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('categorias.destroy',$product->id) }}" method="POST">
                 
                  
                                <a class="btn btn-primary" href="{{ route('categorias.edit',$product->id) }}">Alterar</a>
