<form>
    ...
    <div class="form-group">
        ...
        <select class="form-control" wire:model="usersFor_id">
            <option>Seleccione o Nome do Fornecedor</option>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="120" wire:model="valor">
        @error('quantidade') <span class="text-danger">{{ $message }}</span>@enderror
    </div>
